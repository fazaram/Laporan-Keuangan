...
export function Sidebar() {
    ...
    const menuItems = [
        ...
        },
        {
            ...
            subItems: [
                { href: '/admin/monitoring/transactions', label: 'Transactions', active: pathname === '/admin/monitoring/transactions' },
                { href: '/admin/monitoring/goals', label: 'Goals', active: pathname === '/admin/monitoring/goals' },
                { href: '/admin/monitoring/wallets', label: 'Wallets', active: pathname === '/admin/monitoring/wallets' }
            ]
        },
        {
            href: '/admin/ai',
